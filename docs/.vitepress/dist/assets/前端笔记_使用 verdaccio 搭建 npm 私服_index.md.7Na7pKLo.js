import{_ as s,o as n,c as a,R as p}from"./chunks/framework.rSPAVkc7.js";const e="/fe-blog/assets/1.4mTKiZzQ.png",l="/fe-blog/assets/2._jBR8f7l.png",f=JSON.parse('{"title":"使用 verdaccio 搭建 npm 私服","description":"","frontmatter":{},"headers":[],"relativePath":"前端笔记/使用 verdaccio 搭建 npm 私服/index.md","filePath":"前端笔记/使用 verdaccio 搭建 npm 私服/index.md"}'),i={name:"前端笔记/使用 verdaccio 搭建 npm 私服/index.md"},t=p(`<h1 id="使用-verdaccio-搭建-npm-私服" tabindex="-1">使用 verdaccio 搭建 npm 私服 <a class="header-anchor" href="#使用-verdaccio-搭建-npm-私服" aria-label="Permalink to &quot;使用 verdaccio 搭建 npm 私服&quot;">​</a></h1><h2 id="安装-verdaccio" tabindex="-1">安装 verdaccio <a class="header-anchor" href="#安装-verdaccio" aria-label="Permalink to &quot;安装 verdaccio&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm i verdaccio -g</span></span></code></pre></div><h2 id="启动-verdaccio" tabindex="-1">启动 verdaccio <a class="header-anchor" href="#启动-verdaccio" aria-label="Permalink to &quot;启动 verdaccio&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 直接启动</span></span>
